             ...
             <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form"  method="post"  action="index.php?createJadwal">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="sbj" >
                              </div>
                          </div>
...
<button  class="btn btn-warning btn-lg btn-block"  value="edit" type="submit" name="input">Simpan</button>
                  <hr>    </form>
