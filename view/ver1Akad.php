      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Daftar Peserta Pra  Daftar Ulang UM</h3>
		  		        <div class="row mt">
              <div class="col-lg-12">
...
?>                              <tbody>
                             <tr>
    <td class="numeric" data-title="ID"><?php echo $var['id'];
    $idp= $var['id'];?>&nbsp;</td>
    <td class="numeric" data-title="Nama"><?php echo $var['nama'];?></td>
    <td class="numeric" data-title="Password"><?php echo $var['jenis_kelamin'];?>&nbsp;</td>
    <td class="numeric" data-title="Lokasi Ujian"><?php echo $var['nilaitotal'];  $totp= $var['nilaitotal'];?>&nbsp;</td>
    ...
    <td class="numeric" data-title="Option"><a  class="btn btn-success btn-xs" href="index.php?ver1akad&id=<?php echo $idp ?>&tot=<?php echo $totp;?>&st=<?php echo "1";?>">Verifikasi</a>   
    <a  class="btn btn-danger btn-xs" href="index.php?ver1akad&id=<?php echo $idp ?>&tot=<?php echo $totp;?>&st=<?php echo "2";?>">Tolak</a> </td>
  </tr>
 <?php } 
 } else { ?>   <h3>Maaf Daftar Peserta Kosong</h3> <?php }?> 
                              </tbody>
                          </table>
                          </section>
                  </div><!-- /content-panel -->
