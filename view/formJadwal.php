             ...
             <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Edit Jadwal</h4>
                      <form class="form-horizontal style-form"  method="post"  action="index.php?updatejadwal">
                         <div class="form-group">
                          <?php 
foreach ( $jadwal as $var ) {  
?>

                              <label class="col-sm-2 col-sm-2 control-label">ID_Jadwal</label>
                              <div class="col-sm-10">
                                  <input class="form-control" id="disabledInput" name="idj" type="text" value="<?php echo $var['id'];?>" disabled>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal</label>
                              <div class="col-sm-10">
                                  <input type="date" class="form-control" name="tgl" value="<?php echo $var['tanggal'];?>">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="sbj" value="<?php echo $var['s'];?>">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type=" time" class="form-control"  name="st" value="<?php echo $var['st'];?>">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">End Time</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="et" value="<?php echo $var['et'];   ?>">
                              </div>
                          </div>
                          <?php } ?> 
