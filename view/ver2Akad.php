...
?>                              <tbody>
    ...
    <td class="numeric" data-title="Lokasi Ujian"><?php $nilai= $nilai + $var["nilai_TKD"];
    $nilai= $nilai+$var["nilai_MIPA"];
    $nilai= $nilai+$var["nilai_Bahasa"];
    echo"$nilai" ?>&nbsp;</td>
    ...
    <td class="numeric" data-title="Option"><a  class="btn btn-success btn-xs" href="index.php?ver2akad&id=<?php echo $idp;?>&st=<?php echo "1";?>">Verifikasi</a>   
    <a  class="btn btn-danger btn-xs" href="index.php?ver2akad&id=<?php echo $idp;?>&st=<?php echo "2";?>">Tolak</a> </td>
  </tr>
 <?php }
 } else { ?>
