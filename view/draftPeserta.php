...
// menulis header
$this->Cell(30,10,'Draft Peserta UM- Dokumentasi Universitas Jember',0,0,'L');
...
$this->Cell($w[2],6,$var['namasma'],1);

$this->Cell($w[3],6,$var['tahunlulus'],1);

$this->Cell($w[4],6,$var['namaprodi'],1);

$this->Cell($w[5],6,$var['namalokasi'],1);
$indeks=$indeks+1;
// penutup tabel
...
$header=array('No','Nama Peserta','Nama SMA','Tahun Lulus','Prodi Pilihan','Lokasi Ujian');
$pdf->AddPage();
