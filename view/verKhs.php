   ...
   <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="index.php?homeAdMhs"><img src="assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
                  <h5 class="centered"> <?php echo  $id; ?>-Admin Kemahasiswaan</h5>
                    
                  <li class="mt">
                      <a class="active" href="index.php?homeAdMhs">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="index.php?tabelpesertaKhs">Peserta UM</a></li>
                      </ul>
                  </li>
                 ...
                 <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="index.php?PreDUKhs">Validasi UKT Peserta</a></li>
                      </ul>
                  </li>
...
?>                              <tbody>
    ...
    <td class="numeric" data-title="Option"><a  class="btn btn-success btn-xs" href="index.php?verkhs&id=<?php echo $idp;?>&st=<?php echo "1";?>">Verifikasi</a>   
    <a  class="btn btn-danger btn-xs" href="index.php?verkhs&id=<?php echo $idp;?>&st=<?php echo "2";?>">Tolak</a> </td>
  </tr>
 <?php }
 } else { ?>
