   ...
   <!--sidebar start-->
     ...
     <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Daftar Validasi UKT UM-UNEJ</h3>
                  <div class="row mt">
              <div class="col-lg-12">
...
?>                              <tbody>
    ...
    <td class="numeric" data-title="Option"><a  class="btn btn-success btn-xs" href="index.php?verdkn&id=<?php echo $idp;?>&st=<?php echo "1";?>">Verifikasi</a>   
    <a  class="btn btn-danger btn-xs" href="index.php?verdkn&id=<?php echo $idp;?>&st=<?php echo "2";?>">Tolak</a> </td>
  </tr>
 <?php }
 } else { ?>
